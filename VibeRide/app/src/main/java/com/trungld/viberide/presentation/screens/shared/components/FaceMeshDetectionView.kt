...
import com.trungld.viberide.presentation.screens.shared.utils.PositionUtils.mapFacePointToTarget
...
fun FaceMeshDetectionView(
    ...
    faceMeshesFlow: StateFlow<List<FaceMesh>>,
) {
    val context = LocalContext.current
    val cameraPermissionState =
        rememberPermissionState(permission = Manifest.permission.CAMERA)

    val faceMeshes by faceMeshesFlow.collectAsState()
